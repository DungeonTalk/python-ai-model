...
class MetadataGenerator:
    ...
    # 세계관 키워드 패턴
    WORLD_TYPE_PATTERNS = {
        "FANTASY": ["판타지", "fantasy", "마법", "엘프", "드워프", "오크", "마법사", "기사", "드래곤", "던전", "공허", "기억", "별빛", "메아리"],
        "ZOMBIE": ["좀비", "zombie", "워커", "아포칼립스", "생존자", "바이러스", "아케론", "폐허", "황혼", "새벽", "캠프", "총기", "의약품"],
        "SF": ["sf", "사이버", "우주", "로봇", "ai", "인공지능", "레이저", "우주선", "외계인", "미래"],
        "MODERN": ["현대", "도시", "경찰", "범죄", "스마트폰", "자동차", "회사", "아파트"],
        "HORROR": ["공포", "호러", "유령", "악마", "저주", "괴물"],
        "WESTERN": ["서부", "카우보이", "보안관", "술집", "말", "총잡이"],
        "CYBERPUNK": ["사이버펑크", "해킹", "네온", "메가코프", "사이보그", "가상현실"],
        "STEAMPUNK": ["스팀펑크", "증기", "기계", "톱니바퀴", "발명가", "비행선"],
        "POST_APOCALYPTIC": ["포스트", "아포칼립스", "폐허", "생존", "방사능", "바이러스"]
    }
